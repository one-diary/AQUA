...
const Card = styled.div`
	...
	border-radius: 8px;
	box-shadow: 0 0 1px 0 rgb(8 11 14 / 6%),
				0 6px 6px -1px rgb(8 11 14 / 10%);
	margin: 1rem 1rem 0;
`
				...
				<MainContent>
					<SectionOne>
						...
						<HeadingText>
							...
							Developed to improve and manage continuos evaluation of students by academic institutions, it integrates easily with schools and colleges
						</HeadingText>
					...
					<SectionTwo>
						...
						<CardsContainer>
							<Card>
								...
								<CardBody>
									This feature will allow the Teacher to generate a list of questions from a single word (i.e Wikipedia Articles) or from a specific article which they can upload.This helps in saving precious time for a important or frivoulous quiz.
								</CardBody>
							</Card>
							<Card>
								<CardHeader>
								...
								<CardBody>
									This feature will allow the Teacher to check for plagiarism between students for a subjective assignment. Furthermore, this will reduce confusion and the time can be saved here and teacher can recheck highly plagiarised assignments.
								</CardBody>
							</Card>
							<Card>
								<CardHeader>
								...
								<CardBody>
									This will allow the students to upload their assignments and teachers to see them. This will help them to asses students on how they have performed and can reviewed in the future.
								</CardBody>
							</Card>
						</CardsContainer>
					</SectionTwo>
